...
const GEMINI_MODEL = "gemini-3.5-flash"; // no announced shutdown date as of mid-2026
      ...
      `https://generativelanguage.googleapis.com/v1beta/models/${GEMINI_MODEL}:generateContent`,
      {
        ...
        body: JSON.stringify({
          ...
          generationConfig: {
            ...
            thinkingConfig: {
              thinkingLevel: "low", // valid values for gemini-3.5-flash: low, medium, high ("minimal" is NOT valid and causes a 400 on every request)
            },
          },
          safetySettings: [
